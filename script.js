      ...
      qrImage.onload = async () => {
        ...
        fondo.onload = async () => {
          ...
          try {
            ...
            const mensaje = `Hola! Esta es tu invitación para Condesa 👑\n\nConsta de "${beneficios}" para la noche del ${fechaFormateada}.\n\nVálido sólo con DNI 🪪, hasta las 3:30 hs 🕒.\n\nTe invitó: ${entregadoPor}.\n\nDescargá tu QR desde acá y mostralo en puerta:\n${linkDrive}\n\nDescargá este flyer, poné tu nombre y etiquetanos en IG 🤩:\ndrive.google.com/file/d/1eVR-2W3dBQqw-0sOYnKLk2o5qFXA8aKz/view?usp=drive_link`;
